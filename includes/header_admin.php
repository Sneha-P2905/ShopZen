  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ms-auto">
        ...
        <!-- Admin only links -->
        <li class="nav-item">
          <a class="nav-link" href="/ecommerce_php/admin/dashboard.php">Admin Dashboard</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="/ecommerce_php/admin/product_list.php">Products</a>
        </li>
